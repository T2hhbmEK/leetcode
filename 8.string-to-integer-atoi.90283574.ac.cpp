 ...
 *
 * Medium (13.93%)
 * Total Accepted:    166464
 * Total Submissions: 1195102
 * Testcase Example:  '""'
 *
...
public:
    int myAtoi(string str) {
        ...
        while(c != str.end() && *c-'0'>=0 && '9'-*c>=0) {
            r = 10*r+*c-'0';
            if (r*indicator >= INT_MAX) return INT_MAX;
            if (r*indicator <= INT_MIN) return INT_MIN;
            c++;
        }
        return (int)r*indicator;
    }
};
